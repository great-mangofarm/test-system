...
// 편집기 HTML 탭 소스를 "원본 그대로" 템플릿으로 두고(컴포넌트 구조/ DSL / data-autotype 유지),
// 데이터 컴포넌트(data-cid 3~6)의 data-value + 안쪽 input/textarea 에만 값을 주입한다.
...
//  - cid 0/1/2, 결재선, cid 7(검토의견)은 원본 유지(자동/결재자 작성)
...
// 편집기 HTML 원본 그대로. 데이터 슬롯만 __TOKEN__ 으로 치환.
	...
	<tbody>
		<tr>
			...
			<td colspan="5" style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;">
				<p style="font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 11pt; line-height: 150%; margin-top: 0px; margin-bottom: 0px;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="3" data-dsl="{{calendar}}" data-wrapper="" style="" data-value="__DUE_ATTR__" data-autotype=""><input class="ipt_editor ipt_editor_date" type="text" value="__DUE_VAL__"><span contenteditable="false" class="comp_active" style="display:none;"> <span class="Active_dot1"></span><span class="Active_dot2"></span> <span class="Active_dot3"></span><span class="Active_dot4"></span> </span> <span contenteditable="false" class="comp_hover" data-content-protect-cover="true" data-origin="3"> <a contenteditable="false" class="ic_prototype ic_prototype_trash" data-content-protect-cover="true" data-component-delete-button="true"></a> </span> </span><br></p>
			</td>
		</tr>
		<tr>
			<td style="background: rgb(221, 221, 221); padding: 5px; border: 1px solid black; height: 25px; text-align: center; color: rgb(0, 0, 0); font-size: 14px; font-weight: bold; vertical-align: middle;">
		...
		<tr>
			...
			<td colspan="5" style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;">
				<p style="font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 11pt; line-height: 150%; margin-top: 0px; margin-bottom: 0px;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="5" data-dsl="{{textarea}}" data-wrapper="" style="width: 100%;" data-value="__BG_ATTR__" data-autotype=""><textarea class="txta_editor">__BG_VAL__</textarea><span contenteditable="false" class="comp_active" style="display:none;"> <span class="Active_dot1"></span><span class="Active_dot2"></span> <span class="Active_dot3"></span><span class="Active_dot4"></span> </span> <span contenteditable="false" class="comp_hover" data-content-protect-cover="true" data-origin="5"> <a contenteditable="false" class="ic_prototype ic_prototype_trash" data-content-protect-cover="true" data-component-delete-button="true"></a> </span> </span><br></p>
			</td>
		</tr>
		<tr>
			<td style="background: rgb(221, 221, 221); padding: 5px; border: 1px solid black; height: 25px; text-align: center; color: rgb(0, 0, 0); font-size: 14px; font-weight: bold; vertical-align: middle;">
			...
			<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;" colspan="3">
				<span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="6" data-dsl="{{textarea}}" data-wrapper="" style="width: 100%;" data-value="__RC_ATTR__" data-autotype=""><textarea class="txta_editor">__RC_VAL__</textarea><span contenteditable="false" class="comp_active" style="display:none;"> <span class="Active_dot1"></span><span class="Active_dot2"></span> <span class="Active_dot3"></span><span class="Active_dot4"></span> </span> <span contenteditable="false" class="comp_hover" data-content-protect-cover="true" data-origin="6"> <a contenteditable="false" class="ic_prototype ic_prototype_trash" data-content-protect-cover="true" data-component-delete-button="true"></a> </span> </span>
			</td>
		</tr>
		<tr>
			...
			<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: top;" colspan="3">
				<span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="7" data-dsl="{{textarea}}" data-wrapper="" style="width: 100%;" data-value="" data-autotype=""><textarea class="txta_editor"></textarea><span contenteditable="false" class="comp_active" style="display:none;"> <span class="Active_dot1"></span><span class="Active_dot2"></span> <span class="Active_dot3"></span><span class="Active_dot4"></span> </span> <span contenteditable="false" class="comp_hover" data-content-protect-cover="true" data-origin="7"> <a contenteditable="false" class="ic_prototype ic_prototype_trash" data-content-protect-cover="true" data-component-delete-button="true"></a> </span> </span>
			</td>
		</tr>
	</tbody>
</table>
...
<div style="font-family: 돋움; font-size: 9pt; line-height: 150%; margin-top: 0px; margin-bottom: 0px;"><span style="font-family: 돋움; font-size: 9pt;"></span></div></span></div>·&nbsp;본&nbsp;문서는&nbsp;소프트웨어(서비스&nbsp;또는&nbsp;시스템)&nbsp;개발을&nbsp;요청하는&nbsp;문서입니다.<br>·&nbsp;신규/수정&nbsp;개발이&nbsp;필요한&nbsp;내용을&nbsp;구체적으로&nbsp;작성&nbsp;합니다.<br>·&nbsp;IT개발실장&nbsp;결재시&nbsp;개발&nbsp;책임&nbsp;선정하여&nbsp;검토의견&nbsp;기록<br>·&nbsp;결재선:&nbsp;기안자&nbsp;&gt;&nbsp;기안&nbsp;부서장&nbsp;&gt;&nbsp;PM&nbsp;&gt;&nbsp;IT개발실장<br>·&nbsp;기안&nbsp;승인&nbsp;후&nbsp;요청&nbsp;배경,&nbsp;요청&nbsp;내용&nbsp;등이&nbsp;변경되는&nbsp;경우&nbsp;반드시&nbsp;기존&nbsp;기안을&nbsp;수정해주세요.<br>&nbsp;*&nbsp;필수&nbsp;참조&nbsp;부서: IT개발실a</span></span>`
